...
# ── Run ────────────────────────────────────────────────────────────────────
print("=== Grover Scaling Benchmark ===\n")
print(f"{'N qubits':<12} {'Search space':<16} {'Grover iters':<16} {'Time (s)':>10} {'Classical avg':>15}")
print("-" * 72)
...
for n in range(2, 17):
    ...
    print(f"{n:<12} {space:<16} {k_opt:<16} {elapsed:>10.4f} {classical:>15}")
